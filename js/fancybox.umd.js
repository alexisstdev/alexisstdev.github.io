            ...
            value: function () {
              ...
              var e = new _(this.$container, {
                start: function (i, n) {
                  ...
                  return (
                    !C(o) && !1 !== t.trigger('touchStart', n) && ('mousedown' === n.type && n.preventDefault(), (t.state = 'pointerdown'), t.resetDragPosition(), (t.dragPosition.midPoint = null), (t.dragPosition.time = Date.now()), !0)
                  );
                },
                move: function (i, n, o) {
              ...
              if (!e || 'string' == typeof e) {
                ...
                i ||
                  ...
                  ('html5video' !== i && 'video' !== i) ||
                    ((t.video = k({}, this.fancybox.option('Html.video'), t.video)), t._width && t._height ? (t.ratio = parseFloat(t._width) / parseFloat(t._height)) : (t.ratio = t.ratio || t.video.ratio || Z.video.ratio));
              }
            },
          },
          {
              ...
              if ('video' === t.type && t.$iframe && t.$iframe.contentWindow) {
                !(function e() {
                  if ('done' === t.state && t.$iframe && t.$iframe.contentWindow) {
                    var i;
                    if (t.$iframe.isReady)
                      return t.video && t.video.autoplay && (i = 'youtube' == t.vendor ? { event: 'command', func: 'playVideo' } : { method: 'play', value: 'true' }), void (i && t.$iframe.contentWindow.postMessage(JSON.stringify(i), '*'));
